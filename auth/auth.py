...
AUTH0_DOMAIN = 'practic-misk.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'alnamovies'
...
'''
 check_permissions(permission, payload) method
    ...
    it willl raise an AuthError if the requested permission string is not in the payload permissions array
